...
#import ViewTemplate.msg in openratslam
#import TopologicalAction.msg 
from ratslam_ros.msg import  CombinedTemplateMessage, TopologicalAction
import cv2
...
PC_DIM_XY=11#21
PC_DIM_ABG=36 #From vitaslam
#PC_DIM_TH=36
PC_W_E_DIM=7
PC_W_I_DIM=7 #5 previously for openratslam
PC_W_E_VAR=1
PC_W_I_VAR=2
...
class PosecellNetwork(object):
    ...
    def __init__(self, root='/irat_red',
        ...
        self.pub_pc = rospy.Publisher( self.root + '/PoseCell/TopologicalAction',
                                       TopologicalAction, queue_size=1
                                     )
