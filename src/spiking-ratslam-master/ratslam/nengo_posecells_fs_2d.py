...
n_neurons_xy = 5000#1000#5000
n_neurons_th = 3000#500#3000

n_basis_1d=10
n_basis_2d=30#100#30
n_samples=1000
domain_min = -1
domain_max = 1
...
ps_neuron_type = nengo.LIF()#nengo.Direct()#nengo.LIF() # neuron type for posecells
with model:
    ...
    posecells_xy = nengo.Ensemble(n_neurons=n_neurons_xy, dimensions=fs2d.n_basis + 2,
    ...
    posecells_th = nengo.Ensemble(n_neurons=n_neurons_th, dimensions=fs.n_basis + 1,
                                  neuron_type=ps_neuron_type)
